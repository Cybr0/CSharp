    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0, j = text2.Length - 1; i < text.Length; i++, j--)
            {
                if (text[i] != text2[j])
                {
                    Console.WriteLine("Неявляется обратной!");
                    cheakText = false;
                    break;
                }
            ...
            if (cheakText == true)
            {
                Console.WriteLine("Является обратной!");
            }
            #endregion
            ...
            #region 7
            Console.WriteLine("\n\nExercise 7");
            string someNumbers = "-5,10,5,-45,-4,-3,3,2,1,5,-1";
            string NumbersM = "";
            string NumbersP = "";
            char[] seperatorNumb = { ',', ' ' };
            someNumbers.Split(seperatorNumb);
            for (int i = 0; i < someNumbers.Split(seperatorNumb).Length; i++)
            {
                var temp = someNumbers.Split(seperatorNumb)[i];
                if(temp[0] != '-')
                {
                    NumbersP += temp + ' ';
                }
            ...
            Console.WriteLine(NumbersP + NumbersM);
            #endregion
        }
    }
}
